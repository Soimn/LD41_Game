...
namespace LudumDare41_Game.Entities {
    class Entity_Bob : Entity{
        ...
        public Entity_Bob (EntityManager _entityManager) {
        ...
        public override void Init_Wave (Vector2 _position) {
            ...
            idle = new Animation(contentManager.Load<Texture2D>("Entities/MediumEnemy"), new Vector2((int)size.Width, (int)size.Height), 1, 4f);
