...
namespace LudumDare41_Game.Towers {
    class BombTower : Tower {
        ...
        public BombTower (TowerManager _towerManager, ContentManager _contentManager, EntityManager _entityManager, bool _isPreviewTower = false) {
        ...
        public override void Init (TileCoord _coord) {
            ...
            dmgPotential = (int)TowerDmgPotential.ExtremlyHigh;
            attackCooldown = TowerAttackCooldown.slow;
